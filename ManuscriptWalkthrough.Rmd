...
```{r}
df <- readRDS("~/Desktop/biomark-bioinformatics/data/metawithbiomark.RDS") 
```
...
```{r}
PC_Standards_no_NA <- readRDS("~/Desktop/biomark-bioinformatics/data/ampliconlengths.RDS")
...
flow <- read_excel("~/Desktop/biomark-bioinformatics/data/WOR_Water_flow.xlsx")
...
df <- read_csv("~/Desktop/biomark-bioinformatics/data/water_flow_with_MAB.csv")
...
<!-- # # see: \#\#\#\#\#\#\# -->
<!-- # water_counts <- read_csv("~/Desktop/biomark-bioinformatics/data/WORWATERARGCOUNTS.csv") -->
<!-- #  -->
<!-- # head(water_counts) -->
<!-- # ``` -->
...
```{r}
water_flow_data <- read_csv("~/Desktop/biomark-bioinformatics/data/water_flow_data.csv") %>% 
...
MAB <- read_csv("~/Desktop/biomark-bioinformatics/data/water_flow_with_MAB.csv")
